...
public:
  ...
  AbsState &getState() { return this->_absState; }
...
private:
  ...
  void aloadn(AbsState&, int);
  void pushConstInt(AbsState&, int);
  void pushNull();
  void iconst(AbsState&, int);
  void ldcString(int);
  void ldcAddress(int); 
  void ldcInt32(int); 
  void ldcInt64(int); 
...
public:
  ...
  TR::Region& getRegion()  { return this->_region; }
