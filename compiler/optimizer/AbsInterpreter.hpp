...
class AbsInterpreter : public AbsSemanticsFunctional
   ...
   //Interpreter helpers
   void invoke(int, int, TR::MethodSymbol::Kinds, TR_ResolvedMethod* method, AbsState* absState);
   ...
   void interpretByteCode(AbsState* absState, TR_J9ByteCode bc, TR_J9ByteCodeIterator&);
   ...
   virtual AbsState* checkcast(AbsState*, int, int, TR_ResolvedMethod* method);
   ...
   virtual AbsState* invokedynamic(AbsState*, int, int, TR_ResolvedMethod*);
   virtual AbsState* invokeinterface(AbsState*, int, int, TR_ResolvedMethod*);
   virtual AbsState* invokespecial(AbsState*, int, int, TR_ResolvedMethod*);
   virtual AbsState* invokestatic(AbsState*, int, int, TR_ResolvedMethod*);
   virtual AbsState* invokevirtual(AbsState*, int, int, TR_ResolvedMethod*);
